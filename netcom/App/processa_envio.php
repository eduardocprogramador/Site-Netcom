...
try {                                   
    ...
    $mail->isHTML(true);
    $mail->CharSet = 'UTF-8';
    $mail->Subject = 'Solicitação de Inscrição';
    $mail->Body    = '<strong>Dados:</strong><br>Nome: '.$_POST['nome'].'<br>Telefone: '.$_POST['telefone'].'<br>Email: '.$_POST['email'].'<br>Curso: '.$_POST['curso'];
    if($_POST['nome'] != ''){
        $mail->send();
